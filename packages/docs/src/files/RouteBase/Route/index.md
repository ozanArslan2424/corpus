...
`Route` is the [RouteVariant.dynamic](../index.md#routevariant-dynamic) member of the
...
A [RouteConfig](../index.md#routeconfig) adds schemas for the body, search and params, which both
...
The type parameters are usually inferred from the [RouteConfig](../index.md#routeconfig) rather
...
class fields and call [RouteBase.register](../index.md#routebase-register) themselves.
...
- `model` — Optional [RouteConfig](../index.md#routeconfig) declaring validation schemas and per-route limits. Its schemas also type the `Context` the handler receives.
...
Marks this route as [RouteVariant.dynamic](../index.md#routevariant-dynamic) for `App` route compilation.
...
The [Method](../../Request/index.md#method) this route answers, taken from the [RouteAddress](../index.md#routeaddress).
...
and, since [getContextAccess](../../Context/ContextAccess/index.md#getcontextaccess) inspects it, absent schemas are one of
