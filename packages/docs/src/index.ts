...
function getTemplate() {
	...
	if (!C.Config.isProd) segments.push("src");
...
async function compileNoWrite(outdir: string) {
	initMarked();
...
async function compile(outdir: string): Promise<void> {
