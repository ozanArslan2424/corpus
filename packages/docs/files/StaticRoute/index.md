...
`StaticRoute` is the [`RouteVariant.static`](../RouteBase/index.md#routevariant-static) member of the
...
call [`RouteBase.register`](../RouteBase/index.md#routebase-register) themselves.
...
Marks this route as [`RouteVariant.static`](../RouteBase/index.md#routevariant-static) for `App` route compilation.
...
construction, so what remains is a plain [`RouteConfig`](../RouteBase/index.md#routeconfig).
