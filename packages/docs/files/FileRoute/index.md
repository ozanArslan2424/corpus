...
`FileRoute` is the [`RouteVariant.file`](../RouteBase/index.md#routevariant-file) member of the
...
and call [`RouteBase.register`](../RouteBase/index.md#routebase-register) themselves.
...
Marks this route as [`RouteVariant.file`](../RouteBase/index.md#routevariant-file) for `App` route compilation.
...
The method the file is served on. Taken from the [`RouteAddress`](../RouteBase/index.md#routeaddress); defaults to [`Method.GET`](../Request/index.md#method-get).
...
File routes take no params, search or body, so no [`RouteConfig`](../RouteBase/index.md#routeconfig)
schemas apply.
