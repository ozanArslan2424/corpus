...
`BundleRoute` is the [`RouteVariant.bundle`](../RouteBase/index.md#routevariant-bundle) member of the
...
Marks this route as [`RouteVariant.bundle`](../RouteBase/index.md#routevariant-bundle) for `App` route compilation.
...
Bundles take no params, search or body, so no [`RouteConfig`](../RouteBase/index.md#routeconfig) schemas
apply.
