...
`WebSocketRoute` is the [RouteVariant.websocket](../index.md#routevariant-websocket) member of the
...
1. [WebSocketRoute](#websocketroute)
2. [WebSocketOnMessage](#websocketonmessage)
3. [WebSocketOnClose](#websocketonclose)
4. [WebSocketOnOpen](#websocketonopen)
5. [WebSocketRouteDefinition](#websocketroutedefinition)
...
[RouteBase.register](../index.md#routebase-register) themselves.
...
Marks this route as [RouteVariant.websocket](../index.md#routevariant-websocket), which is what tells
