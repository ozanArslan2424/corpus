...
[`ParsersRegistry.urlParamsParser`](../ParsersRegistry/index.md#parsersregistry-urlparamsparser). It fills [`Context.params`](../Context/index.md#context-params) from
...
[`ParserBase.tryParseJSON`](../ParserBase/index.md#parserbase-tryparsejson), so `/users/42` yields a number rather than a
string.
