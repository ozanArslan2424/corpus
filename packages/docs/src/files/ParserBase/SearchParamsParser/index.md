...
[ParsersRegistry.searchParamsParser](../../Globals/ParsersRegistry/index.md#parsersregistry-searchparamsparser). It fills [Context.search](../../Context/index.md#context-search),
...
1. [SearchParamsParser](#searchparamsparser)
...
Keys are read as paths through [ParserBase.parseKey](../index.md#parserbase-parsekey), so
...
Values are coerced through [ParserBase.tryParseJSON](../index.md#parserbase-tryparsejson), so `?page=2` and
