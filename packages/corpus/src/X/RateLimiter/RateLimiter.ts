...
import type {
	...
	RateLimitIdPrefix,
} from "@/X/RateLimiter/RateLimiter.types";
import { RateLimiterMemoryStore } from "@/X/RateLimiter/RateLimiterMemoryStore";

export class RateLimiter extends MiddlewareAbstract {
