...
(`ParserBaseInterface`, [`BodyParserInterface`](../BodyParser/index.md#bodyparserinterface),
[`SchemaParserInterface`](../SchemaParser/index.md#schemaparserinterface)), never as a concrete class, so a replacement
