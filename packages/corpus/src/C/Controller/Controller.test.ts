...
describe("Controller", () => {
	describe("prefix", () => {
		class PrefixedController extends Controller<"/test"> {
			constructor() {
				super("/test");
			}
		...
		const noPrefixController = new Controller();
	...
	describe("beforeEach", () => {
		it("runs before the handlers", async () => {
			...
			class BeforeEachController extends Controller {
				override beforeEach = () => {
		...
		it("throwing prevents the handler", async () => {
			...
			class ThrowingController extends Controller {
				override beforeEach = () => {
					throw new Exception("unauthorized", Status.UNAUTHORIZED);
				};
	...
	describe("routeIds", () => {
		...
		it("collects external", () => {
			const ctrl = new Controller("/users");
