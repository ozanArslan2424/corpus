...
Constructing an app calls [registerApp](../Globals/AppsRegistry/index.md#registerapp), so it is discoverable without
being passed around.
...
Creates an app and registers it globally with [registerApp](../Globals/AppsRegistry/index.md#registerapp).
...
chain actually reads, as reported by [getContextAccess](../Context/ContextAccess/index.md#getcontextaccess). Routes with
